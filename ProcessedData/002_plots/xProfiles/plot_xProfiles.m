...
clear all;
close all;
sourceName = 'xProfilesData.xlsx'; % in folder 001_regression
...
for i = 1:numel(cases(:,1))
    switch i
        case 1
            ...
            ic = xlsread('regressionData.xlsx', 1, 'C6:E6'); % regressionData.xlsx is in folder 001_regression
            xInt1 = 15:1:110;
        ...
        case 2
            ...
            ic = xlsread('regressionData.xlsx', 1, 'C14:E14'); % regressionData.xlsx is in folder 001_regression
            xInt2 = 5:1:80;
...
%% SEND TO PLOTTING
fPlot_xProfiles(c1xData, c2xData, c3xData,...
